...
public class CalculationTest {
	...
	// 2个POI求坐标
	public static StandardLocationInfo getLocaionBy2Points(double startAngle, Map<String,LocationInfo> locationInfoMap, Map<String,StandardLocationInfo> standardLocationInfoMap, boolean isClockwise) {
		...
		double angle1=locationInfoMap.get(point1).getAngle();
		double angle2=locationInfoMap.get(point2).getAngle();
		if (isClockwise = true) {
			// 构建直角坐标系的4个坐标轴角度
			double[] baseAngles = new double[4];
			baseAngles[0] = startAngle;
